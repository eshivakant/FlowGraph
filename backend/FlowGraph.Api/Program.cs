...
builder.Services.AddSingleton(new SqliteConnectionFactory(sqliteConnString));
...
builder.Services.AddSingleton<IBlobStore>(_ => new FileSystemBlobStore(storageRoot));
...
{
    builder.Services.AddSingleton<Neo4jGraphClient>(_ => new Neo4jGraphClient(neo4jUri!, neo4jUser!, neo4jPass!));
